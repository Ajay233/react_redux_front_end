...
class UpdateQuizForm extends React.Component {
  ...
  onSubmit = ({ name, description, category }) => {
    ...
    put("quiz/update", body, jwt).then((response) => {
      this.props.setQuiz(body);
      this.props.setNotification("Quiz updated", "success", true);
    }).catch((error) => {
...
export default connect(mapStateToProps)(reduxForm({ form: 'quizForm' })(UpdateQuizForm))
